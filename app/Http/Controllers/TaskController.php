...
class TaskController extends Controller
{
    ...
    // reprendre les données et l'objet de type model
    {
        $sortBy = $request->has('tri') ? 'asc':'desc';
        // definition de la variable sortBy avec condition
        // condition : si dans la varioable il y a tri alors trier par ascendant sinon trier par descendant
